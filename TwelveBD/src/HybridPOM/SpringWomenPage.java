...
public class SpringWomenPage 
{
		...
		WebElement TitlePageElement = driver.findElement(By.xpath("/html//div[@id='shopify-section-collection-template']/div//h1"));
	...
	public WebElement CheckingOrder1(WebDriver driver) {
		WebElement CheckingOrder1 = driver.findElement(By.xpath("//*[@id=\"Collection\"]/ul/li[1]/div/a/div[1]"));
	...
	public WebElement CheckingOrder2(WebDriver driver) {
		WebElement CheckingOrder2 = driver.findElement(By.xpath("//*[@id=\"Collection\"]/ul/li[13]/div/a/div[1]"));
		return CheckingOrder2;
	}
	public WebElement Green(WebDriver driver) {
		WebElement GreenElement = driver.findElement(By.xpath("//*[@id=\"Collection\"]/ul/li[3]/div/a/div[1]"));
		return GreenElement;
	}
	 ...
	 public WebElement Cart2(WebDriver driver) throws InterruptedException
	 {	
		 Thread.sleep(3500);
