...
public class HomePagePOM
{
	...
	// click search icon
	 ...
	 public WebElement SpringCollecton(WebDriver driver) {
			WebElement SpringElement = driver.findElement(By.xpath("//*[@id=\"SiteNav\"]/li[1]/button"));
			return SpringElement;
		}

	
		
		public WebElement TitlePage(WebDriver driver) throws InterruptedException {
			Thread.sleep(5000);
		...
		public WebElement DropdownWomen(WebDriver driver)
		{
			WebElement DropElement = driver.findElement(By.xpath("//*[@id=\"SiteNavLabel-eid-collection\"]/ul/li[2]/a"));
			return DropElement;
		}
		...
		{
			WebElement womenselement = driver.findElement(By.xpath("//*[@id=\"SiteNav\"]/li[3]/button"));
