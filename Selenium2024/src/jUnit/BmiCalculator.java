...

{
	...
	public void testBmiCal() throws BiffException, IOException, RowsExceededException, WriteException 
	{
		...
		for (int i = 1; i <= mysheet.getRows() - 1; i++) 
		{
			...
			WebElement gender = dr.findElement(By.xpath(
					"/html/body/div[3]/div[1]/div[4]/div[2]/table/tbody/tr/td/form/table[1]/tbody/tr[2]/td[2]/label[1]/span"));
			gender.click();
	...
	public void openurl()
{
	...
	/*
	 * @After public void closeurl() { dr.close(); }
	 */
